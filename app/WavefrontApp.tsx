      ...
      <main className="main-content">
        {activePuzzle ? (
          ...
          <section className="standard-view tips-view">
            ...
            {hasActivePass && <section className="tips-playbook" aria-label="How to use a puzzle tip"><div className="tips-playbook-copy"><span className="eyebrow">See the move</span><h2>Every good tip is a small experiment.</h2><p>Spot a structure, make one simple move, then check what changes. These mini examples show the kind of thinking the library builds.</p></div><div className="tips-playbook-examples"><article><span>Pattern</span><strong>2, 6, 12, 20</strong><div><b>+4, +6, +8</b><i aria-hidden="true">→</i><em>30</em></div></article><article><span>Logic</span><strong>If A, then B</strong><div><b>B is false</b><i aria-hidden="true">→</i><em>A is false</em></div></article><article><span>Strategy</span><strong>3 equal doors</strong><div><b>1 win, 2 misses</b><i aria-hidden="true">→</i><em>1 in 3</em></div></article></div></section>}
